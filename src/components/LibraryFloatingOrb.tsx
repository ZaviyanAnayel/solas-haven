...
export default function LibraryFloatingOrb() {
  ...
  return (
    <aside aria-label="Sanctuary Library Navigation" className="fixed bottom-3 left-3 sm:bottom-6 sm:left-6 z-40 pointer-events-auto flex items-center group">
      <Link
        href="/library"
        onClick={handleClick}
